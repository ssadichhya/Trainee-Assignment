...
pdb.set_trace()  # Pause here to inspect cart before checkout
customer.checkout()

pdb.set_trace()  # Pause here to debug adding negative quantity
customer.add_to_cart(product1, -1)

pdb.set_trace()  # Pause here to debug removing more quantity
